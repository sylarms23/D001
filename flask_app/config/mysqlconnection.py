...
query = "INSERT INTO usuarios (nombre, apellido, email) VALUES (%(nombre)s, %(apellido)s, %(email)s)  -----> interpolacion a traves de %s para evitar inyecciones SQL de codigo malicioso
results = connectToMySQL('crud_modularizado').query_db(query,diccionario) #Id del nuevo registro
